...
export namespace ProductsService {
    export const baseUrl = 'ECommerceWebsite/Products';
    ...
    export const Methods = {
        Create: "ECommerceWebsite/Products/Create",
        Update: "ECommerceWebsite/Products/Update",
        Delete: "ECommerceWebsite/Products/Delete",
        Retrieve: "ECommerceWebsite/Products/Retrieve",
        List: "ECommerceWebsite/Products/List"
    } as const;
