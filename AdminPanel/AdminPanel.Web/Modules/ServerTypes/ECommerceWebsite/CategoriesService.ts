...
export namespace CategoriesService {
    export const baseUrl = 'ECommerceWebsite/Categories';
    ...
    export const Methods = {
        Create: "ECommerceWebsite/Categories/Create",
        Update: "ECommerceWebsite/Categories/Update",
        Delete: "ECommerceWebsite/Categories/Delete",
        Retrieve: "ECommerceWebsite/Categories/Retrieve",
        List: "ECommerceWebsite/Categories/List"
    } as const;
