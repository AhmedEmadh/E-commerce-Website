...
export namespace ProductImagesService {
    export const baseUrl = 'ECommerceWebsite/ProductImages';
    ...
    export const Methods = {
        Create: "ECommerceWebsite/ProductImages/Create",
        Update: "ECommerceWebsite/ProductImages/Update",
        Delete: "ECommerceWebsite/ProductImages/Delete",
        Retrieve: "ECommerceWebsite/ProductImages/Retrieve",
        List: "ECommerceWebsite/ProductImages/List"
    } as const;
